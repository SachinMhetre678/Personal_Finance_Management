...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ResultSet rs = DatabaseManager.executeQuery("SELECT * FROM user WHERE username = '" + user_id + "' AND password = '" + pass + "'");
            if (rs.next()) {
                JOptionPane.showMessageDialog(null, "Welcome " + user_id + " to Finance Management \n You have Successfully logged in ");
